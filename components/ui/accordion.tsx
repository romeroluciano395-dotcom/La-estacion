...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn(
      "overflow-hidden rounded-xl border border-white/10 bg-white/[0.03] px-5 transition-colors data-[state=open]:border-primary/30 data-[state=open]:bg-white/[0.05]",
      className,
    )}
    {...props}
  />
